...
sealed interface MainViewSelectorState {
    ...
    data class InvitingUsers(val channel: Channel, val showDialog: Boolean = false, val dialogMessage: String = ""): MainViewSelectorState
    ...
    data class ForgotPassword(val showDialog: Boolean = false, val dialogMessage: String? = null): MainViewSelectorState
