...
object ErrorMessages {
    ...
    const val AUTHENTICATED_USER_NULL = "Error retrieving information about the current authenticated user. You'll now be logged out."
    const val UNAUTHORIZED = "You are unauthorized to perform these action. Please sign in again."
